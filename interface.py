...
class Gui():
    ...
    lbCPF.grid(row = 2, column = 0)
    lbEmail.grid(row = 3, column = 1, padx = 50, pady = 50)
    entNome.grid(row = 0, column = 0)
    ...
    btn_allview.grid(row = 4, column = 0, rowspan = 2)
    btn_buscar.grid(row = 5, column = 0, rowspan = 2)
    btn_inserir.grid(row = 6, column = 0, rowspan = 2)
    btn_update.grid(row = 7, column = 0, rowspan = 2)
    btn_del.grid(row = 8, column = 0, rowspan = 2)
    btn_del.grid(row = 9, column = 0, rowspan = 2)
